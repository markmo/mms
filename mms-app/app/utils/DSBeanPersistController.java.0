...
/**
 * This is a <code>BeanPersistController</code> that looks for methods
 * annotated with the JPA Annotations.
 ...
 */
public class DSBeanPersistController extends BeanPersistAdapter {
...
//                System.out.println("Checking if method " + m.toString() + " has annotation on it.");
