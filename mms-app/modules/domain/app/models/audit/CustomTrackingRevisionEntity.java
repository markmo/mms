...
public class CustomTrackingRevisionEntity extends DefaultRevisionEntity {
    ...
    public void addModifiedEntityType(String entityType, String entityId, String revisionType) {
        modifiedEntityTypes.add(new ModifiedEntityTypeEntity(this, entityType, entityId, revisionType));
    }
