...
public class RestAPIUserServices {
	 ...
	 */
	public static UserPageInfo getUsersPage(int pageNumber, String sessionKey) throws SampleAppException{
		 ...
		 */
		if(pageNumber == 1){
			response = HttpRequestHandler.handleRequest("/Users", "$top=" + AppParameter.getUserPerPage(), sessionKey);
		}
		 ...
		 */
			...
			throw new SampleAppException(AppParameter.internalError, AppParameter.internalErrorMessage, null);
		}
	 ...
	 */
	public static User getUser(String objectId, String sessionKey) throws SampleAppException{
	 ...
	 */
	private static JSONArray getMembersOf(String objectID, String sessionKey) throws SampleAppException {
	 ...
	 */
	private static JSONArray getDirectReports(String objectID, String sessionKey) throws SampleAppException {
	 ...
	 */
	private static JSONObject getManager(String objectID, String sessionKey) throws SampleAppException{
	 ...
	 */
	public static UserPageInfo queryCompanyAdmins(String sessionKey) throws SampleAppException {
		...
		if(companyAdminRoleId == null){
			throw new SampleAppException(AppParameter.NoCompanyAdminRole, AppParameter.NoCompanyAdminRoleMessage, null);
		}
	 ...
	 */
	public static String getCompanyAdminRoleId(String sessionKey) throws SampleAppException {
