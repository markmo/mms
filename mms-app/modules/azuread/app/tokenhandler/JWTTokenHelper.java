...
public class JWTTokenHelper {
	...
	private static byte[] signData(String signingKey, String rawToken) throws SampleAppException {
		...
		try {
			...
			throw new SampleAppException(AppParameter.ErrorGeneratingToken, AppParameter.ErrorGeneratingTokenMessage, e1);
		}
		Mac mac;
	...
	public static String getOAuthAccessTokenFromACS(String stsUrl,
		...
		try {
			...
			throw new SampleAppException(AppParameter.ErrorGeneratingToken, AppParameter.ErrorGeneratingTokenMessage, e2);
		}
	}
