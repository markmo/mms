...
public class AzureUsernamePasswordAuthProvider {}/*
        extends
        UsernamePasswordAuthProvider<String, MyLoginUsernamePasswordAuthUser, MyUsernamePasswordAuthUser, AzureUsernamePasswordAuthProvider.MyLogin, AzureUsernamePasswordAuthProvider.MySignup> {
    ...
    protected List<String> neededSettingKeys() {
        final List<String> needed =
                new ArrayList<String>(super.neededSettingKeys());
    ...
    public static AzureUsernamePasswordAuthProvider getProvider() {
        return (AzureUsernamePasswordAuthProvider) PlayAuthenticate
    ...
    public AzureUsernamePasswordAuthProvider(Application app) {
        super(app);
    }
    ...
    protected String onLoginUserNotFound(final Context context) {
        context.flash().put(
                controllers.account.Application.FLASH_ERROR_KEY,
    ...
    protected Body getVerifyEmailMailingBody(final String token,
        ...
        final boolean isSecure = getConfiguration()
                .getBoolean(SETTING_KEY_VERIFICATION_LINK_SECURE);
    ...
    protected Body getPasswordResetMailingBody(final String token,
        ...
        final boolean isSecure = getConfiguration()
                .getBoolean(SETTING_KEY_PASSWORD_RESET_LINK_SECURE);
    ...
    public boolean isLoginAfterPasswordReset() {
        return getConfiguration()
                .getBoolean(SETTING_KEY_LINK_LOGIN_AFTER_PASSWORD_RESET);
    }
