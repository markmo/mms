...
], ($, _, Backbone, Handlebars, app, Vm, PageableView, Paginator, accessPageTemplate, accessChangesTemplate) ->
    PageableView.extend
        el: '#page'
        ...
        _findChanges: ->
            ...
            data = _.chain(vals)
                ...
                .value()
            changes = _.object(_.map(data, (a) -> [a.termId + '|' + a.groupId, a]))
        ...
        update: (event) ->
            ...
            c1 = _.chain(@changes).map((val, key) ->
            ...
            c2 = _.chain(originalValues).map((val, key) ->
                accessChanges = ['C', 'R', 'U', 'D'].map (a) ->
        ...
        preRender: ->
            PageableView.prototype.preRender.call(this)
            if @groupPaginator
        ...
        postRender: ->
            PageableView.prototype.postRender.call(this)
