define [
...
], ($, Backbone, Handlebars, app, Vm, PageableView, PostsView, DomainsView, LeftMenuView, TermLayout, termsPageTemplate) ->
  ...
  PageableView.extend
    ...
    create: ->
      termSection = Vm.create this, 'TermView', TermView,
        terms: @terms
        roles: @roles
        people: @people
    ...
    show: ->
      termSection = Vm.create this, 'TermLayout', TermLayout,
        termId: @termId
      termSection.render().showTerm()
      postsSection = Vm.create this, 'PostsView', PostsView,
        entityType: 'term'
        entityId: @termId
      postsSection.render()
    ...
    initialize: (options) ->
      ...
      Vm.create this, 'DomainsView', DomainsView,
        domains: @domains
      Vm.create this, 'LeftMenuView', LeftMenuView
