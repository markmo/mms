...
insert into mms.os(os_id, os_name) values(1, 'Windows XP');
insert into mms.os(os_id, os_name) values(2, 'Windows 7');
insert into mms.os(os_id, os_name) values(3, 'Windows 8');
insert into mms.os(os_id, os_name) values(4, 'OS X');
insert into mms.os(os_id, os_name) values(5, 'Linux');
insert into mms.os(os_id, os_name) values(6, 'Other Unix');
insert into mms.os(os_id, os_name) values(7, 'Mainframe');
