...
@XmlRootElement(name = "TextModel", namespace = "http://www.dmg.org/PMML-4_1")
public class TextModel {

    @XmlElementRefs({
        @XmlElementRef(name = "ModelVerification", namespace = "http://www.dmg.org/PMML-4_1", type = ModelVerification.class, required = false),
        @XmlElementRef(name = "TextModelNormalization", namespace = "http://www.dmg.org/PMML-4_1", type = TextModelNormalization.class, required = false),
        ...
        @XmlElementRef(name = "DocumentTermMatrix", namespace = "http://www.dmg.org/PMML-4_1", type = DocumentTermMatrix.class, required = false),
        @XmlElementRef(name = "TextDictionary", namespace = "http://www.dmg.org/PMML-4_1", type = TextDictionary.class, required = false),
        ...
        @XmlElementRef(name = "TextModelSimiliarity", namespace = "http://www.dmg.org/PMML-4_1", type = TextModelSimiliarity.class, required = false),
        @XmlElementRef(name = "ModelExplanation", namespace = "http://www.dmg.org/PMML-4_1", type = ModelExplanation.class, required = false),
        @XmlElementRef(name = "TextCorpus", namespace = "http://www.dmg.org/PMML-4_1", type = TextCorpus.class, required = false),
     ...
     * line 273 of file:/Users/markmo/src/mms/mms-app/schema/pmml-4-1.xsd
     * line 260 of file:/Users/markmo/src/mms/mms-app/schema/pmml-4-1.xsd
     * <p>
