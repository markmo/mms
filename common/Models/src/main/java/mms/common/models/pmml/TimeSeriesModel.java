...
@XmlRootElement(name = "TimeSeriesModel", namespace = "http://www.dmg.org/PMML-4_1")
public class TimeSeriesModel {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "TimeSeries", namespace = "http://www.dmg.org/PMML-4_1", type = TimeSeries.class, required = false),
        @XmlElementRef(name = "SpectralAnalysis", namespace = "http://www.dmg.org/PMML-4_1", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "ARIMA", namespace = "http://www.dmg.org/PMML-4_1", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "SeasonalTrendDecomposition", namespace = "http://www.dmg.org/PMML-4_1", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Output", namespace = "http://www.dmg.org/PMML-4_1", type = Output.class, required = false),
        @XmlElementRef(name = "ExponentialSmoothing", namespace = "http://www.dmg.org/PMML-4_1", type = ExponentialSmoothing.class, required = false),
     ...
     * line 1764 of file:/Users/markmo/src/mms/mms-app/schema/pmml-4-1.xsd
     * line 1752 of file:/Users/markmo/src/mms/mms-app/schema/pmml-4-1.xsd
     * <p>
