...
import mms.common.models.ColumnRole;
import mms.common.models.DataType;
...
public class TableColumn extends Column {
    ...
    public mms.common.models.relational.Table getTable() {
        return table;
    }

    public void setTable(mms.common.models.relational.Table table) {
        this.table = table;
    }
}
